...
function DeletePlaylist({ isOpen, onClose, libraryID, playlistName }) {
        ...
        <div id="options">
            ...
            <div className="lv-item">
                <div id="lv-cover">
                    ...
                    <img id='op-cover-img' style={brokenImage} src="" alt="Cover" onError={handleBrokenImage} onLoad={handleImageLoad}/>
                </div>
            ...
            <img id="close-options" className='icons' src="src/assets/player/down.png" alt="" />

            </div>
            <div id="option-list">
                <div onClick={handleDeletePlaylist} className='option-list-item' id="add-to-playlist">
                    <img className='icons' src="/src/assets/player/add.png" alt="+" />
